      ...
      <div className="mx-auto flex max-w-[1512px] flex-col gap-4 px-4 py-4 sm:px-6 lg:flex-row lg:items-center lg:gap-4 lg:px-[47px] lg:py-6">
        <div className="flex items-center justify-between gap-3 lg:contents">
          <div className="flex min-w-0 shrink-0 items-center gap-2 sm:gap-3 lg:order-1">
            ...
            <span className="overflow-visible font-editorial relative top-0.5 truncate text-lg leading-none text-medium-green sm:text-xl lg:top-1 lg:text-2xl">
              FARMACIA COSENTINO
            </span>
          </div>
        ...
        <div className="flex h-[38px] w-full min-w-0 items-center gap-3 rounded-md border border-placeholder bg-white px-4 lg:order-2 lg:mx-auto lg:max-w-[729px]">
